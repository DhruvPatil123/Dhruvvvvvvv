    ...
    <section id="about" className="relative w-full min-h-screen flex items-center justify-center px-6 py-24">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-light text-white tracking-tight leading-tight">
            RESEARCHING <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">INTELLIGENCE</span><br />
            BUILDING COGNITION
          </h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass-effect p-6 rounded-2xl border-l-[3px] border-primary hover:bg-white/[0.08] transition-all duration-300">
            ...
            <div className="glass-effect p-6 rounded-2xl border-l-[3px] border-secondary hover:bg-white/[0.08] transition-all duration-300">
              <p className="text-white font-display font-semibold text-2xl md:text-3xl tracking-tight">1.25M+</p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
          viewport={{ once: true }}
          className="glass-effect p-8 md:p-12 rounded-3xl border border-white/5 relative overflow-hidden group"
        >
